...
from cleaner import clean_excel_dates  # Ensure this is imported
...
def main_ui():
    ...
    tk.Label(
        root,
        text="Bullseye Automation Panel",
        fg="#00ffae",
        bg="#1e1e1e",
    ...
    def clean_file():
        ...
        if not path:
            ...
            return
        clean_excel_dates(path)
        log_box.insert(tk.END, "Dates cleaned successfully!\n")
